...
Public Class cashsales
    ...
    Private Sub CreateTempSales()
        ...
        Session("TempSales").Columns.Add("ExpiryDate", GetType(String))
        Session("TempSales").Columns.Add("BatchNumber", GetType(String))
        ...
        Session("TempSales").Columns.Add("UnitMargin", GetType(Double))
        Session("TempSales").Columns.Add("CostPrice", GetType(Double))
        Session("TempSales").Columns.Add("TotalMargin", GetType(Double))
        Call ItemCount()
    ...
    Protected Sub cmdSaveYesAdd_Click(sender As Object, e As EventArgs) Handles cmdSaveYesAdd.Click
        ...
        Try
            ...
            If Val(VB6.Format(txtAmountPaid.Value, "##0.#0")) < TotalSales Then lblErrMsgAdd.Text = "The Cash Paid is less than Total Amount " : lblErrMsgAdd.ClientVisible = True : txtAmountPaid.Focus() : Exit Sub
    ...
    Private Sub AddSales()
        'On Error Resume Next
        Try
            Dim intSiteID As Integer = 0, intPaymentModeID As Integer = 0
            ...
            strQuery = "EXEC usp_POSSales_Insert " &
            ...
            With GridViewTempSales
                ...
                For i = 0 To .VisibleRowCount - 1
                    ...
                    strQuery = strQuery & " EXEC usp_POSSalesDetails_Insert " &
            ...
            lblSuccessMsgAdd.Text = "Sales Successfully Completed"
    ...
    Private Sub PrintSalesReceipt(ByVal strReceiptNumber As String)
        ...
        If cboPrinter.Text <> "" Then intPriner = cboPrinter.Value
        If intPriner = 1 Then
    ...
    Private Sub PrintSalesReReceipt(ByVal intSalesID As Long)
        ...
        Call CheckUserSession()
        Dim intPriner As Integer = 0
        If cboPrinter.Text <> "" Then intPriner = cboSalesViewPrinter.Value
        If intPriner = 1 Then
    ...
    Protected Sub cmdViewSales_Click()
        ...
        If dt.Rows.Count > 0 Then
            ...
            With dt.Rows(0)
                ...
                txtSalesViewPaymentStatus.Text = .Item("PaymentStatus").ToString
                txtSalesViewPaymentMode.Text = .Item("PaymentMode").ToString
                txtSalesViewPaymentDetails.Text = .Item("PaymentDetails").ToString
                txtSalesViewAmountPaid.Text = .Item("CashPaid").ToString
                txtSalesViewBalance.Text = .Item("Balance").ToString
                txtSalesViewTotalAmount.Text = .Item("TotalSales").ToString
                If CInt(.Item("Paid")).ToString = 1 Then
                    txtSalesViewPaymentStatus.ForeColor = Color.DarkGreen
                ElseIf CInt(.Item("Paid")).ToString = 0 Then
                    txtSalesViewPaymentStatus.ForeColor = Color.Red
    ...
    Private Sub EmptyView()
        ...
        txtSalesViewAmountPaid.Text = 0
        txtSalesViewBalance.Text = 0
    End Sub
    ...
    Private Sub cmdViewReprint_Click(sender As Object, e As EventArgs) Handles cmdViewReprint.Click
        ...
        PrintSalesReReceipt(CLng(txtSalesViewSalesID.Text.Trim.ToUpper))
        PopupPrintReceipt.ShowOnPageLoad = True
    ...
    Private Sub cmdConfirmCancelYes_Click(sender As Object, e As EventArgs) Handles cmdConfirmCancelYes.Click
        ...
        Try
            ...
            objCommand.CommandText = "Usp_POSSales_CancelBySalesID"
    ...
    Private Sub cmdViewPrintWaybill_Click(sender As Object, e As EventArgs) Handles cmdViewPrintWaybill.Click
        Call CheckUserSession()
        Dim report As New XtraRptCashSalesWayBill
        report.Parameters("SalesID").Value = CLng(txtSalesViewSalesID.Text.Trim.ToUpper)
        rptViewerReceipt.OpenReport(report)
        PopupPrintReceipt.ShowOnPageLoad = True

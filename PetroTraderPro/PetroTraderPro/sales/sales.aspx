<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Root.master" CodeBehind="sales.aspx.vb" Inherits="PetroTraderPro.sales" %>
                    ...
                    <dx:LayoutItem ColSpan="1" ShowCaption="False" Caption="">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxButton ID="cmdAddNew" runat="server" Text="Add New" Width="100px" AutoPostBack="False" ClientSideEvents-Click="popupAddSales.Show();">
                                    <ClientSideEvents Click="function(s, e) {popupAddSales.Show();}"></ClientSideEvents>
                                </dx:ASPxButton>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <dx:ASPxPopupControl ID="popupAddSales" runat="server" AllowDragging="True" ClientInstanceName="popupAddSales" CloseAction="CloseButton" HeaderText="Make Sales"  PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Width="1100px">

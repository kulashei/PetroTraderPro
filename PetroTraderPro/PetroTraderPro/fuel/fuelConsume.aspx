<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Root.master" CodeBehind="fuelConsume.aspx.vb" Inherits="PetroTraderPro.fuelConsume" %>
    ...
    <dx:ASPxMenu runat="server" ID="MainMenu" ClientInstanceName="actionToolbar"
        ...
        <Items>
            <dx:MenuItem Enabled="false">
                <Template>
                    <h1 style="color: #0D6B68; font-weight: bold; font-size: large;">Fuel Consumption</h1>
                </Template>
            </dx:MenuItem>
            <dx:MenuItem Name="New" Text="Add Consumption" Alignment="Right" AdaptivePriority="2">
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                            ...
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxGridView ID="GridViewSales" runat="server" AutoGenerateColumns="False" ClientInstanceName="gvModel" Width="100%" DataSourceID="SqlDataSourceSales" KeyFieldName="SalesID" EnableCallBacks="false">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="ProductCode" VisibleIndex="3" Visible="False" Width="50px"></dx:GridViewDataTextColumn>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="SalesCode" VisibleIndex="6" Visible="False" Width="50px"></dx:GridViewDataTextColumn>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="ProductID" VisibleIndex="8" Visible="False" Width="50px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Purpose" VisibleIndex="9" Width="80px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="VehicleNo" VisibleIndex="10" Width="50px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="ReceiptNo" VisibleIndex="11" Width="50px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="AuthorisedBy" VisibleIndex="12" Width="50px"></dx:GridViewDataTextColumn>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="UnitPrice" VisibleIndex="14" Width="50px">
                                            <PropertiesTextEdit DisplayFormatString="#,##0.###0"></PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Amount" VisibleIndex="15" Width="50px">
                                            <PropertiesTextEdit DisplayFormatString="#,##0.#0"></PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="SiteName" VisibleIndex="1" Caption="Site" Width="50px">
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn FieldName="Amount" VisibleIndex="19" Width="50px">
                                            <PropertiesTextEdit DisplayFormatString="#,##0.#0"></PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
                        ...
                        <dx:ASPxFormLayout ID="ASPxFormLayout3" runat="server" Width="100%" ColCount="4" ColumnCount="4">
                            ...
                            <Items>
                                ...
                                <dx:LayoutItem ColSpan="2" Caption="Unit Price" ColumnSpan="2">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxSpinEdit runat="server" MaxValue="999999999999999999999" Number="0" AllowMouseWheel="False" HorizontalAlign="Right" Width="150px" DisplayFormatString="#,##0.###0" ClientInstanceName="txtUnitPriceAdd" ID="txtUnitPriceAdd" ClientEnabled="false">
                                ...
                                <dx:LayoutItem ColSpan="4" ColumnSpan="4" Caption="Pupose No.">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxMemo ID="txtPurposeAdd" runat="server" ClientInstanceName="txtPurposeAdd" Height="71px" Width="100%">
                                                <ValidationSettings ErrorDisplayMode="None" Display="Dynamic" ErrorTextPosition="Bottom" ValidationGroup="Add">
                                                    <RequiredField IsRequired="True"></RequiredField>
                                                </ValidationSettings>
                                            </dx:ASPxMemo>
                                ...
                                <dx:LayoutItem ColSpan="2" ColumnSpan="2" Caption="Authorised By">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxTextBox ID="txtAuthorisedByAdd" runat="server" ClientInstanceName="txtAuthorisedByAdd" Width="100%">
                                                <ValidationSettings ErrorDisplayMode="None" Display="Dynamic" ErrorTextPosition="Bottom" ValidationGroup="Add">
                                                    <RequiredField IsRequired="True"></RequiredField>
                                                </ValidationSettings>
                                            </dx:ASPxTextBox>
                            ...
                            <Items>
                               ...
                               <dx:LayoutItem Caption="Site" ColSpan="2" ColumnSpan="2">
                                ...
                                <dx:LayoutItem ColSpan="4" ColumnSpan="4" Caption="Pupose No.">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxMemo ID="txtPurposeView" runat="server" ClientInstanceName="txtPurposeView" Height="71px" Width="100%" ClientEnabled="true" Font-Bold="True" ForeColor="#0D6B68">
                                                <DisabledStyle ForeColor="#0D6B68" Font-Bold="True">
                                                </DisabledStyle>
                                            </dx:ASPxMemo>
                                        </dx:LayoutItemNestedControlContainer>
                                ...
                                <dx:LayoutItem Caption="Authorized By" ColSpan="2" ColumnSpan="2">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxTextBox ID="txtAuthorisedByView" runat="server" ClientInstanceName="txtAuthorisedByView" Width="100%" ClientEnabled="False" Font-Bold="True" ForeColor="#0D6B68">
                                                <DisabledStyle Font-Bold="True" ForeColor="#0D6B68">
                                                </DisabledStyle>
                                            </dx:ASPxTextBox>
                                        </dx:LayoutItemNestedControlContainer>
                        ...
                        <dx:ASPxFormLayout ID="ASPxFormLayout11" runat="server" ColCount="4" ColumnCount="4" Width="100%">
                            ...
                            <Items>
                                ...
                                <dx:LayoutItem ColSpan="4" ColumnSpan="4" Caption="Pupose No.">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxMemo ID="txtPurposeEdit" runat="server" ClientInstanceName="txtPurposeEdit" Height="71px" Width="100%">
                                ...
                                <dx:LayoutItem ColSpan="2" ColumnSpan="2" Caption="Authorised By">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxTextBox ID="txtAuthorisedByEdit" runat="server" ClientInstanceName="txtAuthorisedByEdit" Width="100%">
                                                <ValidationSettings ErrorDisplayMode="None" Display="Dynamic" ErrorTextPosition="Bottom" ValidationGroup="Edit">
                                                    <RequiredField IsRequired="True"></RequiredField>
                                                </ValidationSettings>
                                            </dx:ASPxTextBox>
            ...
            <asp:SqlDataSource ID="SqlDataSourceSales" runat="server" ConnectionString="<%$ ConnectionStrings:PetroTraderConnectionString %>" SelectCommand="Usp_FuelConsumption_SearchByDateByUser" SelectCommandType="StoredProcedure">
                <SelectParameters>

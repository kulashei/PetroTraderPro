...
Public Class fuelConsume
    ...
    Protected Sub cmdSaveYesAdd_Click(sender As Object, e As EventArgs) Handles cmdSaveYesAdd.Click
            ...
            objCommand.CommandText = "usp_FuelConsumption_Insert"
            ...
            With objCommand.Parameters
                ...
                .Add(New SqlParameter("@Purpose", txtPurposeAdd.Text.Trim.ToUpper))
    ...
    Protected Sub cmdSaveYesEdit_Click(sender As Object, e As EventArgs) Handles cmdSaveYesEdit.Click
       ...
       lblErrMsgedit.ClientVisible = false
        ...
        Try
            ...
            objCommand = New SqlCommand
            objCommand.Connection = objConnect
            objCommand.CommandText = "usp_FuelConsumption_Update"
            objCommand.CommandType = CommandType.StoredProcedure
            ...
            With objCommand.Parameters
                ...
                .Add(New SqlParameter("@SiteID", intSiteID))
                .Add(New SqlParameter("@ProductID", intProductID))
                .Add(New SqlParameter("@Purpose", txtPurposeEdit.Text.Trim.ToUpper))
    ...
    Protected Sub cmdViewSales_Click()
        ...
        Dim dt As DataTable = LoadData(String.Format("SELECT * FROM View_FuelConsumption WHERE SalesID='{0}'", intSalesID)).Tables(0)
        ...
        If dt.Rows.Count > 0 Then
            ...
            With dt.Rows(0)
                ...
                txtPurposeView.Text = .Item("Purpose").ToString
    ...
    Protected Sub cmdConfirmDeleteYes_Click(sender As Object, e As EventArgs) Handles cmdConfirmDeleteYes.Click
        ...
        Dim strQuery As String = String.Format("DELETE FROM FuelConsumption WHERE SalesID={0}", intSalesID)
    ...
    Private Sub cmdEdit_Click(sender As Object, e As EventArgs) Handles cmdEdit.Click
        ...
        If dt.Rows.Count > 0 Then
            ...
            With dt.Rows(0)
                ...
                txtPurposeEdit.Text = .Item("Purpose").ToString
    ...
    Private Sub cmdViewSalesReport_Click(sender As Object, e As EventArgs) Handles cmdViewSalesReport.Click
        ...
        Dim dt As DataTable = LoadData(String.Format("EXEC Usp_FuelConsumption_RPTByDateBySiteID @DateFrom='{0}',@DateTo='{1}', @SiteID={2}", txtSearchDateFrom.Text, txtSearchDateTo.Text, intSiteID)).Tables(0)

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Root.master" CodeBehind="FuelAttendShort.aspx.vb" Inherits="PetroTraderPro.FuelAttendShort" %>
    ...
    <dx:ASPxMenu runat="server" ID="MainMenu" ClientInstanceName="actionToolbar"
        ...
        <Items>
            <dx:MenuItem Enabled="false">
                <Template>
                    <h1 style="color: #0D6B68; font-weight: bold; font-size: large;">Attendants Shortage</h1>
                </Template>
            </dx:MenuItem>
            <dx:MenuItem Name="New" Text="Add" Alignment="Right" AdaptivePriority="2">
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                            ...
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxGridView ID="GridViewSales" runat="server" AutoGenerateColumns="False" ClientInstanceName="gvModel" Width="100%" DataSourceID="SqlDataSourceSales" KeyFieldName="SalesID" EnableCallBacks="false">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="SalesID" VisibleIndex="4" Visible="False" Width="50px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="SalesCode" VisibleIndex="5" Width="50px" Visible="False"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataDateColumn FieldName="SalesDate" VisibleIndex="1" Caption="Date" Width="50px">
                                            <PropertiesDateEdit DisplayFormatString="dd-MMM-yyyy"></PropertiesDateEdit>
                                        </dx:GridViewDataDateColumn>
                                        <dx:GridViewDataTextColumn FieldName="SiteID" VisibleIndex="6" Visible="False" Width="50px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Remark" VisibleIndex="17" Width="100px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="SiteName" VisibleIndex="2" Width="50px" Caption="Site">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Amount" VisibleIndex="16" Width="50px">
                                            <PropertiesTextEdit DisplayFormatString="#,##0.#0"></PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="AttendantName" VisibleIndex="9" Width="50px">
                                            <PropertiesTextEdit DisplayFormatString="#,##0.#0"></PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="AttendantCode" VisibleIndex="18" Visible="False">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="AttendantID" Visible="False" VisibleIndex="19"></dx:GridViewDataTextColumn>
                                    </Columns>
            ...
            <dx:ASPxPopupControl ID="popupAddSales" runat="server" AllowDragging="True" ClientInstanceName="popupAddSales" CloseAction="CloseButton" HeaderText="Add Shortage"  PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Width="800px" Modal="True"  CloseButtonImage-Url="~/img/close-white.png">
                    ...
                    <dx:PopupControlContentControl runat="server">
                        <dx:ASPxFormLayout ID="ASPxFormLayout3" runat="server" Width="100%" ColCount="4" ColumnCount="4">
                            ...
                            <Items>
                                ...
                                <dx:LayoutItem ColSpan="2" Caption="Attendant" ColumnSpan="2">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                    ...
                    <dx:PopupControlContentControl runat="server">
                        <dx:ASPxFormLayout ID="ASPxFormLayout10" runat="server" ColCount="4" ColumnCount="4" Width="100%">
                            ...
                            <Items>
                                ...
                                <dx:LayoutItem Caption="Attendant" ColSpan="2" ColumnSpan="2">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                ...
                                <dx:LayoutItem ColSpan="2" ColumnSpan="2" Caption="Amount">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxSpinEdit runat="server" MaxValue="999999999999999999999" Number="0" AllowMouseWheel="False" HorizontalAlign="Right" Width="120px" DisplayFormatString="#,##0.#0" ClientInstanceName="txtAmountView" ClientEnabled="False" Font-Bold="True" ForeColor="#0D6B68" ID="txtAmountView">
                                                <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                ...
                                <dx:LayoutItem Caption="Remark" ColSpan="4" ColumnSpan="4">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxMemo runat="server" Height="71px" Width="100%" ClientInstanceName="txtRemarkView" Font-Bold="True" ForeColor="#0D6B68" ID="txtRemarkView">
                                                <DisabledStyle Font-Bold="True" ForeColor="#0D6B68"></DisabledStyle>
                                            </dx:ASPxMemo>
                        ...
                        <dx:ASPxFormLayout ID="ASPxFormLayout11" runat="server" ColCount="4" ColumnCount="4" Width="100%">
                            ...
                            <Items>
                                ...
                                <dx:LayoutItem Caption="Amount" ColSpan="2" ColumnSpan="2">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxSpinEdit runat="server" MaxValue="999999999999999999999" Number="0" AllowMouseWheel="False" HorizontalAlign="Right" Width="150px" DisplayFormatString="#,##0.#0" ClientInstanceName="txtAmountEdit" ID="txtAmountEdit">
                                                <SpinButtons ShowIncrementButtons="False"></SpinButtons>

                                                <ClientSideEvents GotFocus="function(s, e) { if (txtAmountEdit.GetValue() == 0)  txtAmountEdit.SetText(&#39;&#39;);}" LostFocus="function(s, e) { if (txtAmountEdit.GetText() == &#39;&#39;)  txtAmountEdit.SetText(&#39;0&#39;);}"></ClientSideEvents>
                                ...
                                <dx:LayoutItem Caption="Remark" ColSpan="4" ColumnSpan="4">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxMemo runat="server" Height="71px" Width="100%" ClientInstanceName="txtRemarkEdit" ID="txtRemarkEdit">
                                                <ValidationSettings ErrorDisplayMode="None" Display="Dynamic" ErrorTextPosition="Bottom" ValidationGroup="Edit">
                                                    <RequiredField IsRequired="True"></RequiredField>
                                                </ValidationSettings>
                                            </dx:ASPxMemo>
            ...
            <asp:SqlDataSource ID="SqlDataSourceSales" runat="server" ConnectionString="<%$ ConnectionStrings:PetroTraderConnectionString %>" SelectCommand="Usp_FuelAttendantShortages_SearchByDateByUser" SelectCommandType="StoredProcedure">
                <SelectParameters>

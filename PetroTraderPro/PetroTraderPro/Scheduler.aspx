<%@ Page Language="VB" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="Scheduler.aspx.vb" Inherits="PetroTraderPro.SchedulerModule" Title="Scheduler" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" PetroTraderPro.Model.SchedulerAppointment"
        TypeName=" PetroTraderPro.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" PetroTraderPro.Model.SchedulerResource"
        TypeName=" PetroTraderPro.Model.ResourceDataSourceHelper"

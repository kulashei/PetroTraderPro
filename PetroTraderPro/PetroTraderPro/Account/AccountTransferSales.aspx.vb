...
Imports System.IO
Public Class AccountTransferSales
    ...
    Protected Sub cmdSaveYesAdd_Click(sender As Object, e As EventArgs) Handles cmdSaveYesAdd.Click
        ...
        Dim intAccountIDFrom As Integer = 0, intAccountIDTo As Integer = 0, intSiteID = 0
        ...
        Try
            ...
            objCommand.CommandText = "usp_AccountsTransfersSite_Insert"
            ...
            With objCommand.Parameters
                ...
                .Add(New SqlParameter("@Charges", txtChargesAdd.Value))
    ...
    Protected Sub cmdSaveYesEdit_Click(sender As Object, e As EventArgs) Handles cmdSaveYesEdit.Click
        ...
        Try
            ...
            objCommand = New SqlCommand
            objCommand.Connection = objConnect
            objCommand.CommandText = "usp_AccountsTransfersSite_Update"
            objCommand.CommandType = CommandType.StoredProcedure
            ...
            With objCommand.Parameters
                ...
                .Add(New SqlParameter("@TransactionNo", txtTransactionNumberEdit.Text.Trim.ToUpper))
                .Add(New SqlParameter("@Charges", txtChargesEdit.Value))
    ...
    Protected Sub cmdViewTransfer_Click()
        ...
        Dim dt As DataTable = LoadData(String.Format("SELECT * FROM View_AccountsTransfers WHERE TransactionID='{0}'", intTransactionID)).Tables(0)
    ...
    Private Sub cmdEdit_Click(sender As Object, e As EventArgs) Handles cmdEdit.Click
        ...
        If dt.Rows.Count > 0 Then
            ...
            With dt.Rows(0)
                ...
                cboAccountFromEdit.Value = CInt(.Item("AccountIDFrom").ToString)
                cboAccountToEdit.Value = CInt(.Item("AccountIDTo").ToString)
    ...
    Private Sub cmdViewTransferReport_Click(sender As Object, e As EventArgs) Handles cmdViewTransferReport.Click
        ...
        Dim dt As DataTable = LoadData(String.Format("EXEC Usp_AccountsTransfersSite_RPTByDateBySiteID @DateFrom='{0}',@DateTo='{1}', @SiteID={2}", txtSearchDateFrom.Text, txtSearchDateTo.Text, intSiteID)).Tables(0)

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Root.master" CodeBehind="AccountTranfers.aspx.vb" Inherits="PetroTraderPro.AccountTranfers" %>
...
<asp:Content runat="server" ContentPlaceHolderID="PageToolbar">
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%" ColCount="6" ColumnCount="6">
        ...
        <Items>
            ...
            <dx:LayoutItem ColSpan="2" Caption="Account" ColumnSpan="2">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer runat="server">
                        <dx:ASPxComboBox runat="server" ID="cboAccountSearch" ClientInstanceName="cboAccountSearch"  DataSourceID="SqlDataSourceSearchAccount" TextField="AccountCode" ValueField="AccountID" ValueType="System.Int32">

                            <ClientSideEvents ValueChanged="function(s, e) {txtAccountSearch.SetValue(cboAccountSearch.GetValue());}"></ClientSideEvents>
                        </dx:ASPxComboBox>
    ...
    <asp:SqlDataSource ID="SqlDataSourceSearchAccount" runat="server" ConnectionString="<%$ ConnectionStrings:PetroTraderConnectionString %>" SelectCommand="SELECT * FROM [View_Accounts] WHERE  AccountID>0 ORDER BY  AccountCode">
        <SelectParameters>
...
<%--                                        <dx:GridViewDataTextColumn FieldName="TransactionID" VisibleIndex="0" Caption=" " Width="40px">
                        ...
                        <dx:ASPxFormLayout ID="ASPxFormLayout3" runat="server" Width="100%" ColCount="6" ColumnCount="6">
                            ...
                            <Items>
                                ...
                                <dx:LayoutItem ColSpan="3" Caption="From" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox runat="server" ValueType="System.Int32" DataSourceID="SqlDataSourceAccount" TextField="AccountCode" ValueField="AccountID" ClientInstanceName="cboAccountFromAdd" ID="cboAccountFromAdd" NullValueItemDisplayText="{1}" TextFormatString="{1}">
                                                <Columns>
                                ...
                                <dx:LayoutItem ColSpan="3" Caption="To" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox runat="server" ValueType="System.Int32" DataSourceID="SqlDataSourceAccount" TextField="AccountCode" ValueField="AccountID" ClientInstanceName="cboAccountToAdd" ID="cboAccountToAdd" NullValueItemDisplayText="{1}" TextFormatString="{1}">
                                                <Columns>
                                                    <dx:ListBoxColumn FieldName="AccountID" ClientVisible="False"></dx:ListBoxColumn>
                                                    <dx:ListBoxColumn FieldName="AccountCode" Width="250px"></dx:ListBoxColumn>
                                                    <dx:ListBoxColumn FieldName="AccountType" Caption="Account Type" Width="150px"></dx:ListBoxColumn>
                        ...
                        <dx:ASPxFormLayout ID="ASPxFormLayout12" runat="server" ColCount="6" ColumnCount="6" Width="100%">
                            ...
                            <Items>
                                ...
                                <dx:LayoutItem Caption="From" ColSpan="3" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="cboAccountFromEdit" runat="server" ClientInstanceName="cboAccountFromEdit" DataSourceID="SqlDataSourceAccount" NullValueItemDisplayText="{1}" TextField="AccountCode" TextFormatString="{1}" ValueField="AccountID" ValueType="System.Int32">
                                                <Columns>
                                ...
                                <dx:LayoutItem Caption="Account" ColSpan="3" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="cboAccountToEdit" runat="server" ClientInstanceName="cboAccountToEdit" DataSourceID="SqlDataSourceAccount" NullValueItemDisplayText="{1}" TextField="AccountCode" TextFormatString="{1}" ValueField="AccountID" ValueType="System.Int32">
                                                <Columns>
                                                    <dx:ListBoxColumn ClientVisible="False" FieldName="AccountID">
                                                    </dx:ListBoxColumn>
                                                    <dx:ListBoxColumn FieldName="AccountCode" Width="250px">
            ...
            <dx:ASPxTextBox ID="txtAccountSearch" runat="server" ClientVisible="false" ClientInstanceName="txtAccountSearch" Text="0">
            </dx:ASPxTextBox>
            ...
            <asp:SqlDataSource ID="SqlDataSourceTransfer" runat="server" ConnectionString="<%$ ConnectionStrings:PetroTraderConnectionString %>" SelectCommand="Usp_AccountsTranfers_SearchByDateByAccountID" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="txtAccountSearch" Name="AccountID" PropertyName="Text" Type="Int32" DefaultValue="-1"/>
                </SelectParameters>
            </asp:SqlDataSource>

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Root.master" CodeBehind="AccountDepositSales.aspx.vb" Inherits="PetroTraderPro.AccountDepositSales" %>
...
<%--                                        <dx:GridViewDataTextColumn FieldName="TransactionID" VisibleIndex="0" Caption=" " Width="40px">
                                        ...
                                        <dx:GridViewDataDateColumn FieldName="SalesDate" VisibleIndex="1" Width="50px">
                                            <PropertiesDateEdit DisplayFormatString="dd-MMM-yyyy"></PropertiesDateEdit>
                                        </dx:GridViewDataDateColumn>
                    ...
                    <dx:PopupControlContentControl runat="server">
                        ...
                        <dx:ASPxFormLayout ID="ASPxFormLayout3" runat="server" Width="100%" ColCount="6" ColumnCount="6">
                            ...
                            <Items>
                                ...
                                <dx:LayoutItem Caption="Sales Date" ColSpan="3" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
...
<%--                                                <ClientSideEvents SelectedIndexChanged="function(s, e) {cbpLoadDataAdd.PerformCallback(); cboAccountAdd.SetSelectedIndex(-1);}"></ClientSideEvents>--%>
            ...
            <asp:SqlDataSource ID="SqlDataSourceDeposit" runat="server" ConnectionString="<%$ ConnectionStrings:PetroTraderConnectionString %>" SelectCommand="Usp_AccountDepositSales_SearchByDateByUser" SelectCommandType="StoredProcedure">
                <SelectParameters>

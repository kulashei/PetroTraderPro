<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Root.master" CodeBehind="AccountDeposit.aspx.vb" Inherits="PetroTraderPro.AccountDeposit" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Head">
    ...
    <script type="text/javascript">
        ...
        function LoadDepositCancel(s, e) {
            txtDepositCancelSite.SetText("");
            txtDepositCancelReceiptNo.SetText("");
            txtAmountAddCanceled.SetText("");
            txtRetrunDetails.SetText("");

            txtDepositCancelSite.SetValue(txtDepositViewSite.GetText());
            txtDepositCancelReceiptNo.SetValue(txtDepositViewReceiptNo.GetText());
            txtAmountAddCanceled.SetValue(txtDepositViewTotalAmount.GetText());

            popupCancelDeposit.Show();
    ...
    <dx:ASPxMenu runat="server" ID="MainMenu" ClientInstanceName="actionToolbar"
        ...
        <Items>
            <dx:MenuItem Enabled="false">
                <Template>
                    <h1 style="color: #0D6B68; font-weight: bold; font-size: large;">Bank Deposits</h1>
                </Template>
            </dx:MenuItem>
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%" ColCount="6" ColumnCount="6">
        ...
        <Items>
            ...
            <dx:LayoutItem ShowCaption="False" ColSpan="1">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer runat="server">
                        <dx:ASPxButton runat="server" ID="cmdViewDepositReport" ClientInstanceName="cmdViewDepositReport" Text="Print Report" Width="120px">
            ...
            <dx:ASPxFormLayout ID="ASPxFormLayout2" runat="server" Width="100%">
                <Items>
                    <dx:LayoutItem ShowCaption="False" ColSpan="1" Width="100%">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxGridView ID="GridViewDeposit" runat="server" AutoGenerateColumns="False" ClientInstanceName="gvModel" Width="100%" DataSourceID="SqlDataSourceDeposit" KeyFieldName="TransactionID" EnableCallBacks="false">
...
<%--                                        <dx:GridViewDataTextColumn FieldName="TransactionID" VisibleIndex="0" Caption=" " Width="40px">
                                            <DataItemTemplate>
                                                <dx:ASPxButton ID="cmdViewDeposit" runat="server" OnClick="cmdViewDeposit_Click"
                                                    Text="View" Theme="SoftOrange" Width="100%">
                                                    <Image Url="../img/view-20.png" Height="16px"></Image>
                                                </dx:ASPxButton>
                                            </DataItemTemplate>
                                        </dx:GridViewDataTextColumn>--%>
                                        <dx:GridViewDataTextColumn FieldName="AccountType" VisibleIndex="12" Visible="False" Width="50px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="AccountCategory" VisibleIndex="13" Visible="False" Width="50px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="AccountCategoryID" VisibleIndex="14" Visible="False" Width="50px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="AccountTypeID" Width="50px" Visible="False" VisibleIndex="15"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="AccountCode" Width="50px" Caption="Account" VisibleIndex="3"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="AccountName" Width="50px" Visible="False" VisibleIndex="16"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="SiteCode" Width="50px" Visible="False" VisibleIndex="19"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="SiteName" Width="50px" Caption="Site" VisibleIndex="2"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="TransactionID" Width="50px" Visible="False" VisibleIndex="21"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="TransactionCode" Width="50px" Visible="False" VisibleIndex="22"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataDateColumn FieldName="TransactionDate" Width="50px" Caption="Trans. Date" VisibleIndex="0">
                                            <PropertiesDateEdit DisplayFormatString="dd-MMM-yyyy"></PropertiesDateEdit>
                                        </dx:GridViewDataDateColumn>
                                        <dx:GridViewDataTextColumn FieldName="SiteID" VisibleIndex="4" Visible="False" Width="50px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="AccountID" VisibleIndex="5" Width="50px" Visible="False"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="TransactionDetails" VisibleIndex="6" Width="100px" Caption="Details">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="PaidBy" VisibleIndex="10" Width="50px"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="PaymentModeID" VisibleIndex="8" Width="50px" Visible="False">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="ChequeNo" VisibleIndex="9" Width="50px" Caption="Trans. No">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Amount" Width="50px" VisibleIndex="11">
                                            <PropertiesTextEdit DisplayFormatString="#,##0.#0"></PropertiesTextEdit>
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="PaymentMode" Width="50px" VisibleIndex="7"></dx:GridViewDataTextColumn>
                                    </Columns>
            ...
            <dx:ASPxPopupControl ID="popupAddDeposit" runat="server" AllowDragging="True" ClientInstanceName="popupAddDeposit" CloseAction="CloseButton" HeaderText="Add Deposit"  PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Width="800px" Modal="True"  CloseButtonImage-Url="~/img/close-white.png">
                ...
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server">
                        ...
                        <dx:ASPxFormLayout ID="ASPxFormLayout3" runat="server" Width="100%" ColCount="6" ColumnCount="6">
                            ...
                            <Items>
                                <dx:LayoutItem Caption="Bank Date" ColSpan="3" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                    ...
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="cboSiteAdd" runat="server" ClientInstanceName="cboSiteAdd" AutoPostBack="true" TextField="SiteName" ValueField="SiteID" ValueType="System.Int32" DataSourceID="SqlDataSourceSites">
                                                <ClientSideEvents SelectedIndexChanged="function(s, e) {cboAccountAdd.SetSelectedIndex(-1);}"></ClientSideEvents>
<%--                                                <ClientSideEvents SelectedIndexChanged="function(s, e) {cbpLoadDataAdd.PerformCallback(); cboAccountAdd.SetSelectedIndex(-1);}"></ClientSideEvents>--%>
                                ...
                                <dx:LayoutItem ColSpan="3" Caption="Account" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            ...
                                            <asp:SqlDataSource runat="server" ID="SqlDataSourceAccountAdd" ConnectionString='<%$ ConnectionStrings:PetroTraderConnectionString %>' SelectCommand="SELECT * FROM [View_AccountSite] WHERE ([SiteID] = @SiteID)   AND AccountTypeID IN(2,3) ORDER BY AccountCode">
                                                <SelectParameters>
                                ...
                                <dx:LayoutItem ColSpan="3" ColumnSpan="3" Caption="Payment Mode">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox runat="server" ID="cboPaymentModeAdd" ClientInstanceName="cboPaymentModeAdd" ValueType="System.Int32" >
                                                <Items>
                                                    <dx:ListEditItem Text="Cash" Value="1"></dx:ListEditItem>
                                                    <dx:ListEditItem Text="Mobile Money" Value="2"></dx:ListEditItem>
                                                    <dx:ListEditItem Text="Cheque" Value="3"></dx:ListEditItem>
                                                </Items>
                                                <ValidationSettings ErrorDisplayMode="None" Display="Dynamic" ErrorTextPosition="Bottom" ValidationGroup="Add">
                                                    <RequiredField IsRequired="True"></RequiredField>
                                                </ValidationSettings>
                                ...
                                <dx:LayoutItem ColSpan="3" ColumnSpan="3" Caption="Paid By">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">

                                            <dx:ASPxTextBox ID="txtPaidByAdd" runat="server" ClientInstanceName="txtPaidByAdd">
                                                <ValidationSettings ErrorDisplayMode="None" Display="Dynamic" ErrorTextPosition="Bottom" ValidationGroup="Add">
                                                    <RequiredField IsRequired="True"></RequiredField>
                                                </ValidationSettings>
                                            </dx:ASPxTextBox>
            ...
            <dx:ASPxPopupControl ID="popupViewDeposit" runat="server" AllowDragging="True" ClientInstanceName="popupViewDeposit" CloseAction="CloseButton" HeaderText="View Deposit" Modal="True"  PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Width="800px"  CloseButtonImage-Url="~/img/close-white.png">
                <SettingsAdaptivity Mode="OnWindowInnerWidth" SwitchAtWindowInnerWidth="700" />
                        ...
                        <dx:ASPxFormLayout ID="ASPxFormLayout11" runat="server" ColCount="6" ColumnCount="6" Width="100%">
                            ...
                            <Items>
                               ...
                               <dx:LayoutItem Caption="Account" ColSpan="3" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxTextBox ID="txtAccountView" runat="server" ClientInstanceName="txtAccountView" ClientEnabled="False" Font-Bold="True" ForeColor="#0D6B68">
                                                <DisabledStyle Font-Bold="True" ForeColor="#0D6B68">
                                                </DisabledStyle>
                                            </dx:ASPxTextBox>
                                        </dx:LayoutItemNestedControlContainer>
                                ...
                                <dx:LayoutItem Caption="Payment Mode" ColSpan="3" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxTextBox ID="txtPaymentModeView" runat="server" ClientInstanceName="txtPaymentModeView" ClientEnabled="False" Font-Bold="True" ForeColor="#0D6B68">
                                                <DisabledStyle Font-Bold="True" ForeColor="#0D6B68">
                                                </DisabledStyle>
                                            </dx:ASPxTextBox>
                                        </dx:LayoutItemNestedControlContainer>
                                ...
                                <dx:LayoutItem Caption="Paid By" ColSpan="3" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxTextBox ID="txtPaidByView" runat="server" ClientInstanceName="txtPaidByView" ClientEnabled="False">
            ...
            <dx:ASPxPopupControl ID="popupEditDeposit" runat="server" AllowDragging="True" ClientInstanceName="popupEditDeposit" CloseAction="CloseButton" HeaderText="Edit Deposit" Modal="True"  PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Width="800px"  CloseButtonImage-Url="~/img/close-white.png">
                <SettingsAdaptivity Mode="OnWindowInnerWidth" SwitchAtWindowInnerWidth="700" />
                <HeaderStyle BackColor="#0D6B68" Font-Bold="True" Font-Size="Large" ForeColor="White" HorizontalAlign="Center" />
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server">
                        <dx:ASPxFormLayout ID="ASPxFormLayout12" runat="server" ColCount="6" ColumnCount="6" Width="100%">
                            ...
                            <Items>
                                ...
                                <dx:LayoutItem Caption="Site" ColSpan="3" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="cboSiteEdit" runat="server" ClientInstanceName="cboSiteEdit" AutoPostBack="true" DataSourceID="SqlDataSourceSites" TextField="SiteName" ValueField="SiteID" ValueType="System.Int32">
                                                <ClientSideEvents SelectedIndexChanged="function(s, e) {cboAccountEdit.SetSelectedIndex(-1);}"></ClientSideEvents>
                                                <ValidationSettings Display="Dynamic" ErrorDisplayMode="None" ErrorTextPosition="Bottom" ValidationGroup="Edit">
                                                    <RequiredField IsRequired="True" />
                                                </ValidationSettings>
                                            </dx:ASPxComboBox>
                                ...
                                <dx:LayoutItem Caption="Account" ColSpan="3" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            ...
                                            <asp:SqlDataSource runat="server" ID="SqlDataSourceAccountEdit" ConnectionString='<%$ ConnectionStrings:PetroTraderConnectionString %>' SelectCommand="SELECT * FROM [View_AccountSite] WHERE ([SiteID] = @SiteID)  AND AccountTypeID IN(2,3) ORDER BY AccountCode">
                                                <SelectParameters>
                                ...
                                <dx:LayoutItem Caption="Payment Mode" ColSpan="3" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxComboBox ID="cboPaymentModeEdit" runat="server" ClientInstanceName="cboPaymentModeEdit" ValueType="System.Int32">
                                                <Items>
                                                    <dx:ListEditItem Text="Cash" Value="1" />
                                                    <dx:ListEditItem Text="Mobile Money" Value="2" />
                                ...
                                <dx:LayoutItem Caption="Paid By" ColSpan="3" ColumnSpan="3">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer runat="server">
                                            <dx:ASPxTextBox ID="txtPaidByEdit" runat="server" ClientInstanceName="txtPaidByEdit">
                                                <ValidationSettings Display="Dynamic" ErrorDisplayMode="None" ErrorTextPosition="Bottom" ValidationGroup="Edit">
                                                    <RequiredField IsRequired="True" />
                                                </ValidationSettings>
                                            </dx:ASPxTextBox>
            ...
            <dx:ASPxPopupControl ID="PopupConfirmDelete" runat="server" AllowDragging="True" ClientInstanceName="PopupConfirmDelete" CloseAction="None" HeaderText="Do you want to Delete the Deposit?" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ShowCloseButton="False" Width="300px" PopupElementID="cmdSubmitRetrun">
                <SettingsAdaptivity Mode="OnWindowInnerWidth" SwitchAtWindowInnerWidth="700" />
                <HeaderStyle HorizontalAlign="Center" />
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server">
            ...
            <asp:SqlDataSource ID="SqlDataSourceDeposit" runat="server" ConnectionString="<%$ ConnectionStrings:PetroTraderConnectionString %>" SelectCommand="Usp_AccountDeposit_SearchByDateByUser" SelectCommandType="StoredProcedure">
                <SelectParameters>

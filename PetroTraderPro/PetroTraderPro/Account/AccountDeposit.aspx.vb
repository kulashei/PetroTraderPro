...
Public Class AccountDeposit
    ...
    Private NCount As Integer, intPaid As Integer, intTransactionID As Long
        ...
        Session("AllUserRoles").DefaultView.RowFilter = "RoleID=28"
        Session("TempUserRole") = Session("AllUserRoles").DefaultView.ToTable

        Session("RoleID28Add") = Session("TempUserRole").Rows(0).Item("CanAdd")
        Session("RoleID28Edit") = Session("TempUserRole").Rows(0).Item("CanEdit")
        Session("RoleID28Delete") = Session("TempUserRole").Rows(0).Item("CanDelete")
        Session("RoleID28View") = Session("TempUserRole").Rows(0).Item("CanView")

        If Session("RoleID28Add") = False Then MainMenu.Items.FindByName("New").ClientEnabled = False
        If Session("RoleID28Edit") = False Then cmdEdit.ClientEnabled = False
        If Session("RoleID28Delete") = False Then cmdDelete.ClientEnabled = False

        If Session("RoleID28View") = False Then cmdSearcByDate.ClientEnabled = False
        If Session("RoleID28View") = False Then cmdViewDepositReport.ClientEnabled = False
    ...
    Protected Sub cmdSaveYesAdd_Click(sender As Object, e As EventArgs) Handles cmdSaveYesAdd.Click
        ...
        Try
            ...
            objCommand.CommandText = "usp_AccountDeposit_Insert"
    ...
    Protected Sub cmdSaveYesEdit_Click(sender As Object, e As EventArgs) Handles cmdSaveYesEdit.Click
        ...
        Try
            ...
            objCommand = New SqlCommand
            objCommand.Connection = objConnect
            objCommand.CommandText = "usp_AccountDeposit_Update"
            objCommand.CommandType = CommandType.StoredProcedure
    ...
    Private Sub cmdViewDepositReport_Click(sender As Object, e As EventArgs) Handles cmdViewDepositReport.Click
        ...
        Dim report As New XtraRptAccountDeposit
        Dim intSiteID = 0
        If cboSiteSearch.Text <> "" Then intSiteID = cboSiteSearch.Value

        Dim dt As DataTable = LoadData(String.Format("EXEC Usp_AccountDeposit_RPTByDateBySiteID @DateFrom='{0}',@DateTo='{1}', @SiteID={2}", txtSearchDateFrom.Text, txtSearchDateTo.Text, intSiteID)).Tables(0)
    ...
    Private Sub cboSiteAdd_ValueChanged(sender As Object, e As EventArgs) Handles cboSiteAdd.ValueChanged
        ...
        cboSiteAdd.DataBind()
        cbpLoadDataAdd.EnableCallbackAnimation = False
    End Sub
